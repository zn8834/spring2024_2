...
<!--  sideBar_end -->
   ...
   <div class="row">
         ...
         <div class="card col-lg-8 shadow mb-4" style=" margin:0px 30px; width:1130px; height:400px;">
          ...
          <div class="card col-lg-8 shadow mb-4" style="margin:0px 20px; width:390px; height:400px;">
            <div class="card-head" style="margin: 10px 0px 0px 0px;"> 
             <h5>Chat</h5>
             <hr style="width:100%; ">
            </div>
   ...
   <div class="row">
         ...
         <div class="card col-lg-8 shadow mb-4" style="margin:0px 30px; width:1130px; height:350px;">
          ...
          <div class="card col-lg-8 shadow mb-4" style="margin:0px 20px; width:390px; height:350px;">
            <div class="card-head" style="margin: 10px 0px 0px 0px;"> 
             <h5>HOT ISSUE</h5>
             <hr style="width:100%; ">
            </div>
